    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div>
                ...
                <a href="<?php echo site_url('subject/index'); ?>" class="btn btn-primary">
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="pass_marks" class="form-control" placeholder="e.g. 3">
                                </div>
